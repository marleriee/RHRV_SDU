...
#' @description
#' Creates time analysis by episode.
#'  .
#' @param HRVData Data structure that stores the beats register and information related to it. 
#' @param size Length of the window by window analysis - default is 300
#' @param Tag Type of episode
#' @param doOutOfEpisodeAnalysis Enable or disable out of episode analysis
...
#' @param numofbins Number of bins used in the analysis - If null it is estimated
#' @param interval Time interval used in the analysis
#' @return Returns a list with two objects, that is, the values of the application of the selected function
#'  inside ("resultIn") and outside ("resultOut") episodes 
CreateTimeAnalysisByEpisodes <-
